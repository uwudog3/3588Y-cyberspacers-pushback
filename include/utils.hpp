...
const float LEFT_DIST_OFFSET = 130 * MM_TO_IN;
const float RIGHT_DIST_OFFSET = 156 * MM_TO_IN;
const float BACK_DIST_OFFSET = 164 * MM_TO_IN;
const float BACKRIGHT_DIST_OFFSET = 110 * MM_TO_IN;
const float FRONTRIGHT_DIST_OFFSET = 200 * MM_TO_IN;
const float FRONTLEFT_DIST_OFFSET = 110 * MM_TO_IN;
const float BACKLEFT_DIST_OFFSET = 200 * MM_TO_IN;
